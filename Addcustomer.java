...
public class Addcustomer extends JFrame implements ActionListener {
    ...
    Addcustomer(String Username){
        ...
        // we use JCombo class for asking question or giving multiple choices. we can also use Choice class 
        ...
        try{
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from account where Username = 'rak_12'");  // ddl command
            while(rs.next()){
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Customer Details addes Successfully");
                setVisible(false);
            }
            catch(Exception e){
                e.printStackTrace();
